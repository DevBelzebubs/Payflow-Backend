...
try {
  ...
  const proxyRequest = async (serviceName, path, method, data, originalHeaders) => {
    ...
    try {
      ...
      console.error(
        `[Gateway Proxy Error] Error al contactar ${serviceUrl}${path}`
      );
  ...
  app.post("/api/auth/demo-login", async (req, res) => {
    try {
      ...
      console.error("[Gateway] Error en /api/auth/demo-login:", error);
  ...
  app.get(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/clientes/:usuarioId (GET):",
          error
        );
  ...
  app.get("/api/productos/:productoId", async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/productos/:productoId (GET):",
        error
      );
      res.status(error.status || 404).json(error);
    }
  ...
  app.put("/api/productos/:productoId", authMiddleware, async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/productos/:productoId (PUT):",
        error
      );
      res.status(error.status || 400).json(error);
    }
  ...
  app.delete("/api/productos/:productoId", authMiddleware, async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/productos/:productoId (DELETE):",
        error
      );
      res.status(error.status || 400).json(error);
    }
  ...
  app.get("/api/servicios/:idServicio", async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/servicios/:idServicio (GET):",
        error
      );
      res.status(error.status || 404).json(error);
    }
  ...
  app.put("/api/servicios/:servicioId", authMiddleware, async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/servicios/:servicioId (PUT):",
        error
      );
      res.status(error.status || 400).json(error);
    }
  ...
  app.delete("/api/servicios/:servicioId", authMiddleware, async (req, res) => {
    try {
      ...
      console.error(
        "[Gateway] Error en /api/servicios/:servicioId (DELETE):",
        error
      );
      res.status(error.status || 400).json(error);
    }
  ...
  app.get(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/ordenes/cliente/:clienteId (GET):",
          error
        );
        res.status(error.status || 500).json(error);
      }
  ...
  app.patch(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/ordenes/:ordenId/estado (PATCH):",
          error
        );
        res.status(error.status || 400).json(error);
      }
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/ordenes/:ordenId/cancelar (POST):",
          error
        );
        res.status(error.status || 400).json(error);
      }
  ...
  app.get(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/cuentas-bancarias/cliente/:clienteId (GET):",
          error
        );
        res.status(error.status || 500).json(error);
      }
  ...
  app.get(
    "/api/cuentas-bancarias/:cuentaId",
    authMiddleware,
    async (req, res) => {
      try {
        const data = await proxyRequest(
        ...
        console.error(
          "[Gateway] Error en /api/cuentas-bancarias/:cuentaId (GET):",
          error
        );
        res.status(error.status || 404).json(error);
      }
  ...
  app.put(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/cuentas-bancarias/:cuentaId (PUT):",
          error
        );
        res.status(error.status || 400).json(error);
      }
  ...
  app.delete(
    ...
    async (req, res) => {
      try {
        ...
        console.error(
          "[Gateway] Error en /api/cuentas-bancarias/:cuentaId (DELETE):",
          error
        );
        res.status(error.status || 400).json(error);
      }
